...
public:
  ...
  virtual std::vector<float> GetRunLengthIntensityStatistics(
      ...
      double *below856, double *below601, double *below250, double *below0) const = 0;
   ...
   * i.e., the range of values shown to th e user. This may be a linear mapping
